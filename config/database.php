    ...
    */
    ...
    'connections' => [
        ...
        'pgsql' => [
            ...
            'host' => env('DB_HOST') ?: env('PGHOST') ?: null,
            'port' => env('DB_PORT') ?: env('PGPORT') ?: null,
            'database' => env('DB_DATABASE') ?: env('PGDATABASE') ?: env('POSTGRES_DB') ?: null,
            'username' => env('DB_USERNAME') ?: env('PGUSER') ?: env('POSTGRES_USER') ?: null,
            'password' => env('DB_PASSWORD') ?: env('PGPASSWORD') ?: env('POSTGRES_PASSWORD') ?: null,
